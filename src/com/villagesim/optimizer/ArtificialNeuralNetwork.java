...
public class ArtificialNeuralNetwork {
    ...
    private double[] computePatternNetwork_fast_13out(double[] patternData)
    {
        double[] output = new double[nodes[nodes.length-1]];
    ...
    private double[] computePatternNetwork_fast_14out(double[] patternData)
    {
        double[] output = new double[nodes[nodes.length-1]];
    ...
    private double[] computePatternNetwork_fast_20out(double[] patternData)
    {
        double[] output = new double[nodes[nodes.length-1]];
        ...
        for(int i = 0; i < nodes[0]; i++)
        {
        	...
        	output[17] += weights[0][17][i] * patternData[i];
        	output[18] += weights[0][18][i] * patternData[i];
        	output[19] += weights[0][19][i] * patternData[i];
        }
